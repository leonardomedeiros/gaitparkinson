function [m, A, EigenGaits] = EigenGaitCore(T)
...
%Is Computing the average of each line
m = mean(T,1); % Computing the average face image m = (1/P)*sum(Tj's)    (j = 1 : P)
Train_Number = size(T,1);
...
EigenGaits = A' * L_eig_vec; % A: centered image vectors
EigenGaits = EigenGaits';